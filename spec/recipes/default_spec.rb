...
describe 'mysqld::default' do
  let(:rhel) { ChefSpec::Runner.new(platform: 'centos', version: '6.5').converge(described_recipe) }
  let(:debian) { ChefSpec::Runner.new(platform: 'ubuntu', version: '12.04').converge(described_recipe) }
